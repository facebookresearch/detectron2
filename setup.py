...
PROJECTS = {
    "detectron2.projects.point_rend": "config/PointRend/point_rend",
    "detectron2.projects.deeplab": "config/DeepLab/deeplab",
    "detectron2.projects.panoptic_deeplab": "config/Panoptic-DeepLab/panoptic_deeplab",
}
