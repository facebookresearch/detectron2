...
class RPNOutputs(object):
    ...
    def _get_ground_truth(self):
        ...
        for image_size_i, anchors_i, gt_boxes_i in zip(self.image_sizes, anchors, self.gt_boxes):
            ...
            if self.boundary_threshold >= 0:
                ...
                print(
                    "RPNOutputs.boundary_threshold: Warning: This is legacy functionality that is turned off by default in Detectron2"
                )
    ...
    def losses(self):
        ...
        assert B == self._boxsz, "RRPN has to have box  dimension {} but has {}".format(
            self._boxsz, B
        )
