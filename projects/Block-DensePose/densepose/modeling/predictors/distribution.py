...
class DensePoseDistributionPredictor(nn.Module):
    """
     ...
     * U coordinates, a tensor of shape [N, Cb * C, Hout, Wout]
     * V coordinates, a tensor of shape [N, Cb * C, Hout, Wout]
    where
    ...
    def __init__(self, cfg: CfgNode, input_channels: int):
        ...
        dim_out_patches_uv = cfg.MODEL.ROI_DENSEPOSE_HEAD.NUM_PATCHES * (cfg.MODEL.BLOCK.BLOCK_NUM + 1)
    ...
    def forward(self, head_outputs: torch.Tensor):
        ...
        return DistributionPredictorOutput(
            ...
            u_dis=self.interp2d(self.u_dis_lowres(head_outputs)),
            v_dis=self.interp2d(self.v_dis_lowres(head_outputs)),
        )